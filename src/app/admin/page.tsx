    ...
    <main id="main-content" className="flex-1">
      ...
      <div className="relative mx-auto max-w-5xl px-6 pt-10 pb-20 md:px-10">
        ...
        <p className="animate-rise-delay max-w-2xl text-lg text-[var(--ink-soft)] leading-relaxed mb-10">
          ...
          <strong>reject</strong> it — and edit the label, severity, rationale,
          or suggested fixes inline. Your work stays in this browser; export it
          when you&rsquo;re done so the changes can be merged into{" "}
