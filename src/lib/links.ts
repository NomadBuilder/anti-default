...
/** Public GitHub repo (product brand: Un-Default). */
export const GITHUB_URL = "https://github.com/NomadBuilder/un-default";
export const GITHUB_ACTION_URL =
  "https://github.com/NomadBuilder/un-default/blob/main/action.yml";
export const CLI_DOCS_URL =
  "https://github.com/NomadBuilder/un-default#add-it-in-under-a-minute";
